  ...
  const ResultsDisplay = ({ results }) => {
    ...
    return (
      <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-orange-600 mb-6">Optimization Results</h2>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Summary */}
          <div className="bg-orange-50 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-orange-700 mb-3">Summary</h3>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="space-y-3">
              {Object.entries(results.assignments).map(([truck, locations]) => (
                <div key={truck} className="bg-white rounded p-3 border-l-4 border-orange-400">
                  <p className="font-medium text-orange-700">{truck}</p>
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.entries(results.per_vehicle_summary).map(([truck, summary]) => (
              <div key={truck} className="bg-white border-2 border-orange-100 rounded-lg p-4">
                <h4 className="font-semibold text-orange-600 mb-2">{truck}</h4>
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white border border-gray-200 rounded-lg">
              <thead className="bg-orange-50">
                <tr>
                  <th className="px-4 py-2 text-left font-semibold text-orange-700">Location</th>
                  {Object.keys(results.counts_by_location[Object.keys(results.counts_by_location)[0]]).map(truck => (
                    <th key={truck} className="px-4 py-2 text-center font-semibold text-orange-700">{truck}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h1 className="text-3xl font-bold text-orange-600 mb-6 text-center">Vehicle Routing Optimizer</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
                  ...
                  <div className="flex gap-1">
                    <input
                      ...
                      className="w-1/2 px-2 py-2 border rounded-md focus:ring-2 focus:ring-orange-500 text-sm"
                    />
                    <input
                      type="number"
                      placeholder="End"
          ...
          <div className="mb-6 bg-orange-50 rounded-lg p-4">
            <h2 className="text-lg font-semibold text-orange-700 mb-3">Constraints</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Max Distance per Vehicle</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Max Time per Vehicle</label>
                <input
                  type="number"
          ...
          <div className="text-center">
            <button
              ...
              disabled={loading}
              className="bg-orange-600 text-white px-8 py-3 rounded-lg hover:bg-orange-700 transition-colors flex items-center gap-2 mx-auto text-lg font-semibold disabled:opacity-50"
            >
