...
const OtpPageTD = () => {
  ...
  const handleOTPSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        // For existing users, check if professional details are complete
        if (!isRegistration && result.user?.uid) {
          ...
          // For new registrations, go to professional details form first
          navigate('/auth/driver/professional-details', {
            state: {
              phone: phone,
              isNewUser: true
