...
const SignUpB = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      // Create Firebase account for business user
      const result = await registerWithEmail(email, password, 'business', {
        email: email
      });
      
      if (result.success) {
        // Navigate to business details page with user ID
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-2xl font-bold text-center mb-6">Create Business Account</h2>
