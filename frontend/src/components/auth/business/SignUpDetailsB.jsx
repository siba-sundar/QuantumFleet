...
const SignUpDetailsB = () => {
  ...
  const handleDetailsSubmit = async (e) => {
    ...
    try {
      ...
      const requiredFields = ['firstName', 'lastName', 'streetAddress', 'city', 'state', 'zipCode', 'dateOfBirth', 'firmName', 'firmPhone', 'firmStreetAddress', 'firmCity', 'firmState', 'firmZipCode', 'businessType', 'panNumber'];
